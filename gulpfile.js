...
gulp.task('js:dev', function () {
    return gulp.src(['node_modules/svg4everybody/dist/svg4everybody.min.js', 'node_modules/owl.carousel/dist/owl.carousel.min.js', 'node_modules/magnific-popup/dist/jquery.magnific-popup.min.js'])
...
gulp.task('dev', gulp.series('clean', gulp.parallel('sass:dev', 'pug', 'js:dev', 'js:copy', 'svg', 'img:dev', 'fonts', 'svg:copy')));

gulp.task('build', gulp.series('clean', gulp.parallel('sass:build', 'pug', 'js:build', 'js:copy', 'svg', 'img:build', 'fonts', 'svg:copy')));
